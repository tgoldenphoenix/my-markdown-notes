...
`IEEE 802.11 wireless LAN` is the set of standards that defines **Wi-Fi**. It's part of the IEEE 802 family of networking standards. The 802.11 standard specifically describes how wireless communication works at the Data Link (Layer 2) and Physical (Layer 1) layers of the OSI model.
