...
- 免 (弓日竹山) - rabbit
  - 晚 (日 // 弓日山) - double unit
  - 鬼 (竹山戈) - ghost
- 兔 (弓日竹戈, F3+L) or V5 (弓山 // 戈, double unit)
- 兎 (竹中日戈) - F3+L
...
- 歹 (一弓戈) - malicious, bones
  - 殯 (一弓 // 十 // 一金)
- 死 (一弓 // 心) - double unit, death, F+L // L
  - 葬 (廿 // 一心 // 廿) - interment
  - 髒 (月月 // 廿 // 一廿)
